package Class::Value::Contact::Exception::InvalidFaxNo;

# $Id: InvalidFaxNo.pm 13653 2007-10-22 09:11:20Z gr $
...
use constant default_message => 'Invalid fax number [%s]';
...
Class::Value::Contact::Exception::InvalidFaxNo - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Exception::InvalidFaxNo->new;
...
Class::Value::Contact::Exception::InvalidFaxNo inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::InvalidFaxNo>.
