package Class::Value::Contact::Exception::ReplacePhoneNo;

# $Id: ReplacePhoneNo.pm 8617 2005-03-23 13:43:00Z gr $
...
use base 'Class::Value::Contact::Exception::Replace';


use constant default_message => 'Phone number [%s] replaced with [%s]';
...
Class::Value::Contact::Exception::ReplacePhoneNo - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Exception::ReplacePhoneNo->new;
...
Class::Value::Contact::Exception::ReplacePhoneNo inherits from
L<Class::Value::Contact::Exception::Replace>.

The superclass L<Class::Value::Contact::Exception::Replace> defines these
methods and functions:

    clear_original(), clear_replacement(), original(), original_clear(),
    replacement(), replacement_clear()
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::ReplacePhoneNo>.
