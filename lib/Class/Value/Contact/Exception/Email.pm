package Class::Value::Contact::Exception::Email;

# $Id: Email.pm 13653 2007-10-22 09:11:20Z gr $
...
use base 'Class::Value::Contact::Exception';


__PACKAGE__->mk_scalar_accessors(qw(email));


use constant default_message => 'Exception in email address [%s]';
use constant PROPERTIES      => ( 'email' );
...
Class::Value::Contact::Exception::Email - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Exception::Email->new;
...
Class::Value::Contact::Exception::Email inherits from
L<Class::Value::Contact::Exception>.
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::Email>.
