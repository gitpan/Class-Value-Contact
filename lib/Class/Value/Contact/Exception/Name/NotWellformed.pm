...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::Exception::Name::NotWellformed->new;
...
Class::Value::Contact::Exception::Name::NotWellformed inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::Name::NotWellformed>.
