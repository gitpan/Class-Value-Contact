package Class::Value::Contact::Exception::Name::Invalid;

# $Id: Invalid.pm 9376 2005-06-27 12:23:30Z gr $
...
use base 'Class::Value::Contact::Exception::Name';


use constant default_message => 'Invalid name [%s]';
...
Class::Value::Contact::Exception::Name::Invalid - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Exception::Name::Invalid->new;
...
Class::Value::Contact::Exception::Name::Invalid inherits from
L<Class::Value::Contact::Exception::Name>.

The superclass L<Class::Value::Contact::Exception::Name> defines these
methods and functions:

    clear_name(), name(), name_clear()
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::Name::Invalid>.
