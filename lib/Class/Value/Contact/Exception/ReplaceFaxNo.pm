package Class::Value::Contact::Exception::ReplaceFaxNo;

# $Id: ReplaceFaxNo.pm 8617 2005-03-23 13:43:00Z gr $
...
use constant default_message => 'Fax number [%s] replaced with [%s]';
...
Class::Value::Contact::Exception::ReplaceFaxNo - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Exception::ReplaceFaxNo->new;
...
Class::Value::Contact::Exception::ReplaceFaxNo inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::ReplaceFaxNo>.
