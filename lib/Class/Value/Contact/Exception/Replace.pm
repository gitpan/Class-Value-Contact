...
# $Id: Replace.pm 13653 2007-10-22 09:11:20Z gr $
...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::Exception::Replace->new;
...
=item clear_replacement

    $obj->clear_replacement;

Clears the value.

=item original

    my $value = $obj->original;
    $obj->original($value);
...
=item replacement
    ...
    my $value = $obj->replacement;
    $obj->replacement($value);

A basic getter/setter method. If called without an argument, it returns the
value. If called with a single argument, it sets the value.

=item replacement_clear

    $obj->replacement_clear;

Clears the value.

=back

Class::Value::Contact::Exception::Replace inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::Replace>.
