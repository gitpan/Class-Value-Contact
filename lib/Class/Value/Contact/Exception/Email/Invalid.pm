...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::Exception::Email::Invalid->new;
...
Class::Value::Contact::Exception::Email::Invalid inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::Email::Invalid>.
