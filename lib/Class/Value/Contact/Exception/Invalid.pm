package Class::Value::Contact::Exception::Invalid;

# $Id: Invalid.pm 13653 2007-10-22 09:11:20Z gr $
#
# Generic exception for contact values that are invalid.
...
use constant default_message => 'Invalid contact value [%s]';
...
Class::Value::Contact::Exception::Invalid - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Exception::Invalid->new;
...
Class::Value::Contact::Exception::Invalid inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Exception::Invalid>.
