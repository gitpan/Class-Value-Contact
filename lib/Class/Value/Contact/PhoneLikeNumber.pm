...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::PhoneLikeNumber->new;
...
Class::Value::Contact::PhoneLikeNumber inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::PhoneLikeNumber>.
