...
# $Id: PhoneNumber.pm 8617 2005-03-23 13:43:00Z gr $
...
use base 'Class::Value::Contact::PhoneLikeNumber';
...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::PhoneNumber->new;
...
Class::Value::Contact::PhoneNumber inherits from
L<Class::Value::Contact::PhoneLikeNumber>.

The superclass L<Class::Value::Contact::PhoneLikeNumber> defines these
methods and functions:

    normalize_value(), send_notify_value_invalid(),
...
This document describes version 0.02 of L<Class::Value::Contact::PhoneNumber>.
