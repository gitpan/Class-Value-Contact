...
# $Id: EmailAddress.pm 9377 2005-06-27 12:24:14Z gr $
...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::EmailAddress->new;
...
Class::Value::Contact::EmailAddress inherits from L<Class::Value::Contact>.
...
The superclass L<Class::Value> defines these methods and functions:
    ...
    normalize_value(), notify_delegate(), notify_delegate_clear(),
    run_checks(), run_checks_with_exception_container(),
    send_notify_value_normalized(), set_value(), skip_checks(),
...
This document describes version 0.02 of L<Class::Value::Contact::EmailAddress>.
