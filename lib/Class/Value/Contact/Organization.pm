package Class::Value::Contact::Organization;

# $Id: Organization.pm 8617 2005-03-23 13:43:00Z gr $
...
Class::Value::Contact::Organization - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Organization->new;
...
Class::Value::Contact::Organization inherits from L<Class::Value::Contact>.
...
This document describes version 0.02 of L<Class::Value::Contact::Organization>.
