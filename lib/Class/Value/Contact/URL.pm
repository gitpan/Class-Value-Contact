package Class::Value::Contact::URL;

# $Id: URL.pm 8617 2005-03-23 13:43:00Z gr $
...
Class::Value::Contact::URL - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::URL->new;
...
Class::Value::Contact::URL inherits from L<Class::Value::Contact>.
...
This document describes version 0.02 of L<Class::Value::Contact::URL>.
