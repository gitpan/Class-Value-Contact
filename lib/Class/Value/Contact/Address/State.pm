package Class::Value::Contact::Address::State;

# $Id: State.pm 8617 2005-03-23 13:43:00Z gr $
...
Class::Value::Contact::Address::State - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Address::State->new;
...
Class::Value::Contact::Address::State inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Address::State>.
