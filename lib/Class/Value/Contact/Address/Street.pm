package Class::Value::Contact::Address::Street;

# $Id: Street.pm 8617 2005-03-23 13:43:00Z gr $
...
Class::Value::Contact::Address::Street - contact-related value objects

=head1 SYNOPSIS

    Class::Value::Contact::Address::Street->new;
...
Class::Value::Contact::Address::Street inherits from
...
This document describes version 0.02 of L<Class::Value::Contact::Address::Street>.
