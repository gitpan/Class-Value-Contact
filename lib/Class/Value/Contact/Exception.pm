...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::Exception->new;
...
Class::Value::Contact::Exception inherits from
L<Class::Value::Exception::Base>.
...
This document describes version 0.02 of L<Class::Value::Contact::Exception>.
