...
=head1 SYNOPSIS
    ...
    Class::Value::Contact::Name::Full->new;
...
Class::Value::Contact::Name::Full inherits from L<Class::Value::Contact>.
...
This document describes version 0.02 of L<Class::Value::Contact::Name::Full>.
